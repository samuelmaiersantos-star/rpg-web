...
const levels = {
    1: {
        ...
        objetivo: "Colete 4 itens",
        backgroundColor: "#2d4a2e",
        itemsNeeded: 4
    },
    2: {
        nome: "Caverna Sombria",
        objetivo: "Sobreviva por 10 segundos",
...
function setupLevel1() {
    items = [
        ...
        { x: 100, y: 350, tipo: "berinjela", emoji: "🍆", valor: 100 },
        { x: 500, y: 250, tipo: "coisaboa", emoji: "🆓🆒", valor: 1000000000000000000000000 }
...
function setupLevel2() {
    ...
    enemies = [
        ...
        { x: 600, y: 250, direcao: -1, velocidade:18, emoji: "🐅🎰",dano:30}
    ];
...
function setupLevel3() {
    ...
    enemies = [
        { x: 200, y: 150, direcao: 1, velocidade: 28, emoji: "🐉", dano: 20 },
        { x: 600, y: 200, direcao: -1, velocidade: 5, emoji: "⚔️", dano: 18 },
         { x: 400, y: 250, direcao: -1, velocidade:10, emoji: "🍑💨",dano:10000}
    ];
